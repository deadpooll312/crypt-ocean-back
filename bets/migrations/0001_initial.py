# Generated by Django 2.2.7 on 2020-05-02 08:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='RUB', max_digits=14, verbose_name='Сумма ставки')),
                ('coefficient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bets.Coefficient', verbose_name='Коэффициент')),
